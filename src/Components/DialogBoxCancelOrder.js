        ...
        <div className="bg-white rounded-lg shadow-xl overflow-hidden transform transition-all max-w-lg w-96 ">
          <div className="flex flex-col p-2 gap-3">
            <div className="text-sm p-2 flex flex-row items-center gap-2" style={{color:"#343434"}}>
                <div className="h-4 w-4 flex items-center justify-center rounded-full text-xs cursor-pointer" style={{border:"1.5px solid #EC3030",color:"#EC3030"}} onClick={closeDialog}>X</div>
            ...
            <div className="flex justify-between">
              <button
                className="py-1 px-2 rounded-md  w-44"
                style={{ border: "1px solid #A5A5A5", color: "#A5A5A5", fontWeight:"500", fontSize:"14px" }}
                onClick={closeDialog}
              >
                Cancel
              </button>
              <button
                ...
                style={{ border: "1px solid #A5A5A5", backgroundColor: "#EC3030", color:"white",fontWeight:"500", fontSize:"14px" }}
