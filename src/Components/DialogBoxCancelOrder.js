      ...
      <div className='flex items-center justify-center min-h-screen p-4'>
        ...
        <div className='bg-white rounded-lg shadow-xl overflow-hidden transform transition-all max-w-lg w-96 '>
          <div className='flex flex-col p-2 gap-3'>
            <div
              className='text-sm p-2 flex flex-row items-center gap-2'
              style={{ color: '#343434' }}
            >
              <div
                className='h-4 w-4 flex items-center justify-center rounded-full text-xs cursor-pointer'
                style={{ border: '1.5px solid #EC3030', color: '#EC3030' }}
                onClick={closeDialog}
              >
                X
              </div>
